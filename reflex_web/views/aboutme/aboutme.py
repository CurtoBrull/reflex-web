...
def aboutme() -> rx.Component:
    ...
    return rx.box(
        rx.center(
            rx.text("Sobre Mí", style=st.text_h1_title_stile),
        ),
        rx.vstack(
            rx.text("¡Hola! Soy Javier Curto.",
                    style=st.text_h2_stile,
                    ),
            rx.text("Decidido dar el paso fuera de mi zona de confort, "
                    "finalmente me embarqué en el fascinante viaje de explorar mi pasión por la informática y la programación. "
            ...
            rx.text("Actualmente, cuento con conocimientos en una variedad de tecnologías, "
                    ...
                    "Sin embargo, mi sed de aprendizaje continúa, y estoy siempre en búsqueda de nuevas habilidades y conocimientos."),
        ...
        rx.hstack(
            rx.box(
                rx.text("Datos Personales", style=st.text_h3_stile),
                rx.list(
                    rx.list.item("Email"),
            ...
            rx.box(
                rx.text("Intereses", style=st.text_h3_stile),
                rx.list(
